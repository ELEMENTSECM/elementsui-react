...
const config = {
	paths: {
		applicationPath: '',
		absoluteUrl: 'https://gvs-elements.gecko.no/f_dka_CorsEnabled/AuthenticationCallback',
		baseUrl: 'https://gvs-elements.gecko.no/f_dka_CorsEnabled',
		devAppRoot: 'https://gvs-elements.gecko.no/f_dka_CorsEnabled/App',
		releaseAppRoot: 'https://gvs-elements.gecko.no/f_dka_CorsEnabled/App_Build',
		appRoot: 'https://gvs-elements.gecko.no/f_dka_CorsEnabled/App'
	},
